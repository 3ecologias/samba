...
'''
    icone_loja = 'static/icons/256x256/Colorido/participacao_e_controle_social.svg'
    icone_sidebar = 'static/icons/16x16/Colorido/participacao_e_controle_social.svg'
    indicadores = [
        ('A10', {

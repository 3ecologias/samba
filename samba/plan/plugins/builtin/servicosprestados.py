...
class QualidadeServicosPrestados(Plugin):
    ...
    '''
    icone_loja = 'static/icons/256x256/Colorido/qualidade_dos_servicos_prestados.svg'
    icone_sidebar = 'static/icons/16x16/Colorido/qualidade_dos_servicos_prestados.svg'
    indicadores = [
        ('SQ1', {
